                ...
                <div class="product-details-img product-details-tab">
                    <div class="zoompro-wrap zoompro-2">
                        <div class="zoompro-border zoompro-span">
                            <img class="zoompro"
                                src="{{ LoadAssets('assets/images/product-image/organic/display/1.jpg') }}"
                    ...
                    <div id="gallery" class="product-dec-slider-2">
                        <a class="active" data-image="assets/images/product-image/organic/display/1.jpg"
                            ...
                            <img src="{{ LoadAssets('assets/images/product-image/organic/product-11.jpg') }}" alt="" />
                        </a>
                        <a data-image="assets/images/product-image/organic/display/2.jpg"
                            ...
                            <img src="{{ LoadAssets('assets/images/product-image/organic/product-9.jpg') }}" alt="" />
                        </a>
                        <a data-image="assets/images/product-image/organic/display/3.jpg"
                            ...
                            <img src="{{ LoadAssets('assets/images/product-image/organic/product-20.jpg') }}" alt="" />
                        </a>
                        <a data-image="assets/images/product-image/organic/display/4.jpg"
                            ...
                            <img src="{{ LoadAssets('assets/images/product-image/organic/product-19.jpg') }}" alt="" />
                        </a>
                    </div>
                </div>
            </div>
            <div class="col-xl-6 col-lg-6 col-md-12">
                <div class="product-details-content">
                    ...
                    <div class="pro-details-policy">
                        <ul>
                            <li><img src="LoadAssetsurl('assets/images/icons/policy.png" alt=""') }} /><span>Security Policy (Edit With
                                    Customer Reassurance Module)</span></li>
                            <li><img src="LoadAssetsurl(' assets/images/icons/policy-2.png" alt')
                                    }}="" /><span>Delivery
                                    Policy (Edit With
                                    Customer Reassurance Module)</span></li>
                            <li><img src="LoadAssetsurl('assets/images/icons/policy-3.png" alt') }}="" /><span>Return
                                    Policy
                                    (Edit With
                                    Customer Reassurance Module)</span></li>
                        </ul>
                            ...
                            <div class="review-wrapper">
                                <div class="single-review">
                                    <div class="review-img">
                                        <img src="LoadAssetsurl('assets/images/testimonial-image/1.png" alt') }}="" />
                                    </div>
                                ...
                                <div class="single-review child-review">
                                    <div class="review-img">
                                        <img src="LoadAssetsurl('assets/images/testimonial-image/2.png" alt') }}="" />
                                    </div>
                                    <div class="review-content">
                                        <div class="review-top-wrap">
                                            <div class="review-left">
        ...
        <div class="recent-product-slider owl-carousel owl-nav-style">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-11.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-12.jpg') }}" alt="" />
                    </a>
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-1.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-1.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-3.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-4.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-6.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-6.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-22.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-15.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-14.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-14.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
        ...
        <div class="recent-product-slider owl-carousel owl-nav-style">
                ...
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-22.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-23.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-9.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-9.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-18.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-18.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-7.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-8.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
            ...
            <article class="list-product">
                <div class="img-block">
                    <a href="single-product.html" class="thumbnail">
                        <img class="first-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-17.jpg') }}" alt="" />
                        <img class="second-img"
                            src="{{ LoadAssets('assets/images/product-image/organic/product-16.jpg') }}" alt="" />
                    </a>
                    <div class="quick-view">
                        <a class="quick_view" href="#" data-link-action="quickview" title="Quick view"
                            data-bs-toggle="modal" data-bs-target="#exampleModal">
